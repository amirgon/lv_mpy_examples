...
class Theme():
    def __init__(self,script_dir):
        ...
        self.style_ddbox_pad.set_pad_left(lv.STATE.DEFAULT, 3)
        self.style_ddbox_pad.set_pad_right(lv.STATE.DEFAULT, 0)
        self.style_ddbox_pad.set_pad_inner(lv.STATE.DEFAULT, 0)
        ...
        self.style_pad.set_pad_left(lv.STATE.DEFAULT, self.LV_VER_RES // 50)
        self.style_pad.set_pad_right(lv.STATE.DEFAULT, self.LV_VER_RES // 50)
        ...
        '''
        self.style_list_btn.set_pad_left(lv.STATE.DEFAULT, self.LV_HOR_RES // 100)
        self.style_list_btn.set_pad_right(lv.STATE.DEFAULT, self.LV_HOR_RES // 100)
        ...
        self.style_list_btn.set_pad_inner(lv.STATE.DEFAULT, self.LV_HOR_RES // 100)
        '''
        self.style_list_btn.set_pad_left(lv.STATE.DEFAULT, 5)
        self.style_list_btn.set_pad_right(lv.STATE.DEFAULT, 5)
        self.style_list_btn.set_pad_top(lv.STATE.DEFAULT, 5)
        self.style_list_btn.set_pad_bottom(lv.STATE.DEFAULT, 5)
        self.style_list_btn.set_pad_inner(lv.STATE.DEFAULT, 5)
        ...
        self.style_ddlist_bg.set_text_font(lv.STATE.DEFAULT,self.font_montserrat_10)

        self.style_ddlist_list = lv.style_t()
        self.style_ddlist_list.init()
        self.style_ddlist_list.set_text_font(lv.STATE.DEFAULT,self.font_montserrat_10)
        ...
        self.style_slider_knob.set_pad_top(lv.STATE.DEFAULT, 5)
        self.style_slider_knob.set_pad_bottom(lv.STATE.DEFAULT, 5)
        self.style_slider_knob.set_pad_left(lv.STATE.DEFAULT, 5)
        self.style_slider_knob.set_pad_right(lv.STATE.DEFAULT,  5)
        self.style_slider_knob.set_pad_top(lv.STATE.PRESSED, 8)
        self.style_slider_knob.set_pad_bottom(lv.STATE.PRESSED, 8)
        self.style_slider_knob.set_pad_left(lv.STATE.PRESSED, 8)
        self.style_slider_knob.set_pad_right(lv.STATE.PRESSED,  8)
    ...
    def apply(self,obj,name):
        ...
        if name == LV_DEMO_PRINTER_THEME_TITLE:
            obj.add_style(lv.obj.PART.MAIN,self.style_title)
            return
    ...
    def get_font_normal(self):
        return self.font_montserrat_10

    def get_font_subtitle(self):
        return self.font_montserrat_14
