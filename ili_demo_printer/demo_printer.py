...
class DemoPrinter(object):
    ...
    def home_open(self,delay):
        ...
        box = lv.obj(lv.scr_act(), None)
        box_w = 80;
        box.set_size(box_w, 50)
        box.align(None, lv.ALIGN.IN_BOTTOM_RIGHT, - self.LV_HOR_RES // 20 + 10,
                     - self.LV_HOR_RES // 20)
    ...
    def add_icon(self,parent,src_bg_dsc,src_icon_dsc,txt):
        ...
        icon.align(None, lv.ALIGN.IN_TOP_RIGHT, -12, 12)
    ...
    def setup_icon_event_cb(self,obj,evt):
        if evt == lv.EVENT.CLICKED:
            ...
            img.align(None, lv.ALIGN.CENTER, -14, -10)
            ...
            img.align(None, lv.ALIGN.CENTER, 0, -26)
            ...
            img.align(None, lv.ALIGN.CENTER, 32, -42)
    ...
    def scan1_open(self,btn_txt):
        ...
        self.scan_img.align(None, lv.ALIGN.IN_TOP_LEFT, 3, 60)
        ...
        icon.align(slider, lv.ALIGN.OUT_TOP_MID, 0, -14)

        self.scan_img_color_refr();

        next_btn = lv.btn(lv.scr_act(), None)
        self.theme.apply(next_btn, LV_DEMO_PRINTER_THEME_BTN_CIRCLE)
        next_btn.set_size(box_w, 20)
        next_btn.align(self.scan_img, lv.ALIGN.OUT_RIGHT_BOTTOM, 5, 0)
        if btn_txt == "NEXT":
    ...
    def scan_next_event_cb(self,obj,evt):
        ...
        if evt == lv.EVENT.CLICKED:
            ...
            # dropdown_box.align_mid(None, lv.ALIGN.CENTER, 0, -10)
            dropdown_box.set_fit(lv.FIT.NONE)
            dropdown_box.set_layout(lv.LAYOUT.ROW_MID)
            dropdown_box.align(None, lv.ALIGN.IN_BOTTOM_LEFT, 3, -5)
            ...
            dropdown.set_width((box_w - 3 * self.LV_HOR_RES // 60 ) // 2 + 10)            
            self.theme.apply(dropdown,lv.THEME.DROPDOWN)

            box_w = 120
            settings_box = lv.obj(lv.scr_act(), None)
            settings_box.set_size(box_w, self.LV_VER_RES // 2)
            settings_box.align(None, lv.ALIGN.IN_TOP_RIGHT, -5, 60)
            ...
            print_btn.set_size(box_w, 30)
            print_btn.set_event_cb(self.print_start_event_cb)
            
            btn_ofs_y = (dropdown_box.get_height() - print_btn.get_height()) // 6
    ...
    def info_bottom_create(self, label_txt, btn_txt, btn_event_cb, delay):
        LV_DEMO_PRINTER_BTN_W =  80
        LV_DEMO_PRINTER_BTN_H =  20
        
        txt = lv.label(lv.scr_act(), None)
        txt.set_text(label_txt)
        self.theme.apply(txt,LV_DEMO_PRINTER_THEME_LABEL_WHITE)
        txt.align(None,lv.ALIGN.CENTER, 0, 40)
        ...
        btn.align(txt, lv.ALIGN.OUT_BOTTOM_MID, 0, 24)
    ...
    def internet_icon_event_cb(self,obj,evt):
        if evt == lv.EVENT.CLICKED:
            ...
            img = lv.img(lv.scr_act(), None)
            img.set_src(self.img_printer2_dsc)
            img.align(None, lv.ALIGN.CENTER, -16, -20)
            ...
            img = lv.img(lv.scr_act(), None)
            img.set_src(self.img_no_internet_dsc)
            img.align(None, lv.ALIGN.CENTER, 20,-36)
            ...
            img = lv.img(lv.scr_act(), None)
            img.set_src(self.img_cloud_dsc)
            img.align(None, lv.ALIGN.CENTER, 52, -52)
    ...
    def mobile_icon_event_cb(self,obj,evt):
        if evt == lv.EVENT.CLICKED:
            ...
            img = lv.img(lv.scr_act(), None)
            img.set_src(self.img_printer2_dsc)
            img.align(None, lv.ALIGN.CENTER, -36, -20)
            ...
            img.align(None, lv.ALIGN.CENTER, 0, -20)
            ...
            img.align(None, lv.ALIGN.CENTER, 32, -20)
    ...
    def usb_icon_event_cb(self,obj,evt):
        if evt == lv.EVENT.CLICKED:
            ...
            dropdown_box.set_layout(lv.LAYOUT.ROW_MID)
            dropdown_box.set_size(box_w , self.LV_VER_RES // 5)
            dropdown_box.align(None, lv.ALIGN.IN_BOTTOM_LEFT, 20, -20)
            ...
            settings_box = lv.obj(lv.scr_act(), None)
            settings_box.set_size(box_w, self.LV_VER_RES // 2);
            settings_box.align(list, lv.ALIGN.OUT_RIGHT_TOP, self.LV_HOR_RES // 40, 0)
            ...
            btn_ofs_y = (dropdown_box.get_height() - print_btn.get_height()) // 4
            print_btn.align(settings_box, lv.ALIGN.OUT_BOTTOM_MID, 0, self.LV_HOR_RES // 40 + btn_ofs_y)
            print_btn.set_style_local_value_str(lv.obj.PART.MAIN, lv.STATE.DEFAULT, "PRINT")
            print_btn.set_style_local_value_font(lv.obj.PART.MAIN, lv.STATE.DEFAULT, self.theme.get_font_subtitle())
            print_btn.set_style_local_bg_color(lv.obj.PART.MAIN, lv.STATE.DEFAULT, LV_DEMO_PRINTER_GREEN)
            print_btn.set_style_local_bg_color(lv.obj.PART.MAIN, lv.STATE.PRESSED, LV_DEMO_PRINTER_GREEN.color_darken(lv.OPA._20))
